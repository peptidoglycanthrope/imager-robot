...
#define PARAM_READOUT_TIME          ((CLASS2<<16) + (TYPE_FLT64<<24)     + 179) // The real type is TYPE_UNS32
...
#define PARAM_PP_FEAT_ID            ((CLASS2<<16) + (TYPE_UNS16<<24)    +  549) // The real type is TYPE_UNS32
#define PARAM_PP_PARAM_ID           ((CLASS2<<16) + (TYPE_UNS16<<24)    +  550) // The real type is TYPE_UNS32
...
#define PARAM_SMART_STREAM_EXP_PARAMS       ((CLASS2<<16) + (TYPE_VOID_PTR<<24) +  702) // The real type is TYPE_SMART_STREAM_TYPE_PTR
#define PARAM_SMART_STREAM_DLY_PARAMS       ((CLASS2<<16) + (TYPE_VOID_PTR<<24) +  703) // The real type is TYPE_SMART_STREAM_TYPE_PTR
...
void MyCamera::pvcamCallbackEofEx3(const FRAME_INFO* pFrameInfo, void* pContext)
{
...
*/
typedef void(*PL_CALLBACK_SIG_LEGACY)(void);

/**
A callback function signature for the pl_cam_register_callback_ex() function.
@param pContext A pointer to the user defined context that was previously
passed into the pl_cam_register_callback_ex() function.
*/
typedef void(*PL_CALLBACK_SIG_EX)(void* pContext);

/**
A callback function signature for the pl_cam_register_callback_ex2() function.
@param pFrameInfo A pointer to a FRAME_INFO structure uniquely identifying
the incoming frame.
*/
typedef void(*PL_CALLBACK_SIG_EX2)(const FRAME_INFO* pFrameInfo);
...
*/
typedef void(*PL_CALLBACK_SIG_EX3)(const FRAME_INFO* pFrameInfo, void* pContext);
